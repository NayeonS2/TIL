...
> - .md 파일 수정후 git status
> - git add . -> git status
> - *git commit -m "modified 개발자로 성장하기"*
...
```python
A@DESKTOP-F5A48Q4 MINGW64 ~/ssafy8/TIL (master)
$ git remote add origin https://github.com/NayeonS2/TIL.git

A@DESKTOP-F5A48Q4 MINGW64 ~/ssafy8/TIL (master)
$ git remote -v
origin  https://github.com/NayeonS2/TIL.git (fetch)
origin  https://github.com/NayeonS2/TIL.git (push)
```
...
> - git clone https://github.com/NayeonS2/test.git 
> - local로 복제, .git 같이 복제, (remote주소도 같이복제) 
> - git init, git remote add ~ 할필요 ㄴㄴ
...
***************************************************
> - <강의장> 
> 1. 집에서 공부한 것 "git pull origin master"
> 2. 강의장에서 한거 add , push


> - <집>
> 1. 강의장에서 한거 pull
> 2. 집에서 공부한 것 add, commit, "git push origin master"
---

## ***Clone vs. Push**
> - ### *clone :* 
> - local로 복제
> - .git 같이 복제(remote주소도 같이복제)
> - git init, git remote add ~ 할필요 ㄴㄴ
>- git add (master아니라서 안됨)
